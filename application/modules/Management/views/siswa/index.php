...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    ...
	    table = $('#tbl').dataTable({
	      ...
	      serverSide : true,
	      ajax : {
	        url : '<?=base_url('administrator/management/user/siswa/'.$this->ubah->encode('get_ajax'))?>',type : 'POST'},
	        columns : [
        		{'data' : 'id_siswa'},
        		{'data' : 'nama_siswa'},
        		{
        		...
        		},
        		{
        			...
        			'mRender' : function(data) {
        				return '<a href="javascript:;" onclick=repair("'+data.reset+'") class="btn btn-primary"><i class="fa  fa-recycle"></i> Reset Sandi</a> <a href="javascript:;" onclick=change("'+data.switch+'") class="btn btn-primary"><i class="fa  fa-recycle"></i> Ganti Status</a>';
        				// return data.action;
        			}
        		},

...
<script type="text/javascript">
	...
	$('#add').click(function() {
		...
		$('.modal-body').load('<?=base_url('administrator/guru/'.$this->ubah->encode('_form'))?>',function(o,t,tr) {
			response(this,o,tr);
		});
	})
	$(document).ready(function() {
	    ...
	    table = $('#tbl').dataTable({
	      ...
	      serverSide : true,
	      ajax : {
	        url : '<?=base_url('administrator/guru/'.$this->ubah->encode('get_ajax'))?>',type : 'POST'},
	        columns : [
        		{'data' : 'id_guru'},
        		{'data' : 'nama_guru'},
        		{'data' : 'nama_mapel'},
        		{
        			...
        			'mRender' : function(data) {
        				return "<a href='javascript:;' class='btn btn-warning' onclick=ubah('"+data.edit+"')><i class='fa fa-pencil'></i> Edit</a> <a href='javascript:;' onclick=del('"+data.delete+"')><i class='fa fa-trash'></i> Delete</a>";
        			}
        		},

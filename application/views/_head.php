      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?=base_url('dist/img/'.$this->session->userdata('img'))?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url('dist/img/'.$this->session->userdata('img'))?>" class="user-image" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php
          if ($this->session->userdata('as') == 'Admin') {
            ?>
            <li id="manuser" class="treeview">
              <a href="javascript:;" id="guru">
                <i class="fa  fa-users"></i>
                <span>Guru</span>
              </a>
            </li>
            <li id="manuser" class="treeview">
              <a href="javascript:;" id="siswa">
                <i class="fa  fa-users"></i>
                <span>Siswa</span>
              </a>
            </li>
            <li id="manuser" class="treeview">
              <a href="javascript:;" id="mapel">
                <i class="fa  fa-users"></i>
        ...
        if ($this->session->userdata('as') == 'Guru') {
          ?>
          <li id="manuser" class="treeview">
          <a href="javascript:;" id="materi">
            <i class="fa  fa-users"></i>
            <span>Materi</span>
          </a>
        </li>
        <li id="manuser" class="treeview">
          <a href="javascript:;" id="soal">
            <i class="fa  fa-users"></i>
            <span>Soal</span>
          </a>
        </li>
           ...
           ?>
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li id="man_guru"><a href="javascript:;"><i class="fa fa-user"></i> Guru</a></li>
                <li id="man_siswa"><a href="javascript:;"><i class="fa fa-user"></i> Siswa</a></li>
                <li id="man_admin"><a href="javascript:;"><i class="fa fa-user"></i> Admin</a></li>
              </ul>
            </li>
           <?php
         }
